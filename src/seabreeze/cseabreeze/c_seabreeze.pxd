...
cdef extern from "api/seabreezeapi/SeaBreezeAPI.h":
    ...
    cdef cppclass SeaBreezeAPI:
        ...
        int spectrometerGetFastBufferSpectrum(long deviceID, long spectrometerFeatureID, int *errorCode, unsigned char *dataBuffer, int dataMaxLength, unsigned int numberOfSampleToRetrieve) nogil # currently 15 max
